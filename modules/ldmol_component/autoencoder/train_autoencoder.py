...
#     # logger
#     swan_logger = SwanLabLogger(project='LDMol_Autoencoder', experiment_name='pretrain_autoencoder', save_dir='./swanlab_logs') 
...
if __name__ == '__main__':
    raise ValueError("Training is not allowed.")
